...
) : ReadOnlyFaceStore<P, F> by localStore, WebSocketInstance by WebSocketBroker<P, F>(url, localStore, gson, false)
...
constructor(
        ...
        localStore: ReadWriteFaceStore<P, F>,
        gson: Gson = BitmapConverter.createGson()
) : CompositeReadWriteFaceStore<P, F, ReadOnlyFaceStore<P, F>>(localStore), WebSocketInstance by WebSocketBroker<P, F>(url, localStore, gson, true) {
